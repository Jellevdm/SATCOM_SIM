...
for i in range(number_of_files):  # 0-tot
    csv_file_path = f'pico/pico_{i+1:03}.csv'  # Format i+1 as a zero-padded 3-digit number
    csv_data = read_csv(csv_file_path)

    for row in csv_data[3::100]:  # Start from the 4th row and take every 100th row
...
output_file_path = 'pico_total.csv'  # Replace with your desired output file path
