...
file_name = "SATCOM_SIM/Simulation files/FSM inputs/04-30-inputs/04_30-fsm-std(0.1)-mean(0.1).csv"                   # Change this to read different inputs  

# Configure toml file and initialise link budget
#-----------------------------------------------
config_path = "SATCOM_SIM/Simulation files/config.toml"
